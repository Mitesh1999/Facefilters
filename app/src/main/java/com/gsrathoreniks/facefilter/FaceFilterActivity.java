...
public class FaceFilterActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        //add new imagebutton event

        ImageButton brooom = (ImageButton) findViewById(R.id.broom);
        brooom.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                findViewById(MASK[typeFace]).setBackgroundResource(R.drawable.round_background);
                typeFace = 13;
                findViewById(MASK[typeFace]).setBackgroundResource(R.drawable.round_background_select);
        ...
        ImageButton herry_glasses = (ImageButton) findViewById(R.id.herry_glasses);
        herry_glasses.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                findViewById(MASK[typeFace]).setBackgroundResource(R.drawable.round_background);
                typeFace = 15;
                findViewById(MASK[typeFace]).setBackgroundResource(R.drawable.round_background_select);
